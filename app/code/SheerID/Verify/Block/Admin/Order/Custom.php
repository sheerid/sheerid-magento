...
class SheerID_Verify_Block_Admin_Order_Custom extends Mage_Core_Block_Template
{
    ...
    protected function _toHtml() {
        ...
        $str .= Mage::helper('sales')->__("SheerID Verification:");
        $str .= '</label></td><td class=\"value\"><strong>';
		
		$affs = implode(", ", explode(",", $this->order->getSheeridAffiliations()));
		$info = $this->order->getSheeridResult() ? "Verified ($affs)" : "Not Verified";
